...
echo -e "${Info} Wireguard VPS AutoScript by RizkyVib"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/syntax-er0r/Mumet/main/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/syntax-er0r/Mumet/main/delwg.sh"
wget -O cekwg "https://raw.githubusercontent.com/syntax-er0r/Mumet/main/cekwg.sh"
wget -O xp-wg "https://raw.githubusercontent.com/syntax-er0r/Mumet/main/xp-wg.sh"
wget -O renewwg "https://raw.githubusercontent.com/syntax-er0r/Mumet/main/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x cekwg
chmod +x xp-wg
