...
wget -O /etc/openvpn/easy-rsa/vars "https://raw.githubusercontent.com/syntax-er0r/Mumet/main/vars.conf"
...
# install openvpn
wget -O /etc/openvpn/vpn.zip "https://github.com/syntax-er0r/Mumet/raw/main/vpn.zip"
cd /etc/openvpn/
unzip vpn.zip
rm -f vpn.zip
cd
...
mkdir clientconfig
cp /etc/openvpn/{RizkyVib.crt,RizkyVib.key,ca.crt,ta.key} clientconfig/
cd clientconfig
